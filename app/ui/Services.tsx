                ...
                <div className="grid sm:grid-cols-2 md:grid-cols-3  lg:w-[90%]  mx-auto gap-y-14 gap-x-16">
                    {
                        services.map((service, index) => (
                            <div key={index} className=" mx-auto relative z-40  w-full">

                                <Link href={`/services/${index}`} className="group flex flex-col justify-start items-start  duration-500 relative  px-4 py-8  rounded-md border-2 border-[--primary_color]  hovered_card w-full"
                                >
                                    {/* <div

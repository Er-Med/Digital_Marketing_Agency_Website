            ...
            <div className='info flex flex-col'>
              ...
              <div>
                ...
                <p className='text-lg text-[--dark_gray_color]'>
                  ...
                  Numquam voluptatem laborum debitis et sit officia aut, modi
                  harum, veniam labore vel voluptates molestias consectetur non
                  iure eum corrupti. Ex, necessitatibus?
                </p>
                <div className='media'>
                  <SocialBtns />
                </div>

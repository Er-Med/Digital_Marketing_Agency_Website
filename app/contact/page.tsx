    ...
    return (
        <div className="contact">
            <div className="container px-4  md:px-14 mx-auto">
                ...
                <div className=" mx-auto relative rounded-lg pb-6 mb-32">
                    <div className="grid lg:grid-cols-3 items-center gap-8 md-gap-16 xl:gap-24">
                        <div>
                            <div className="grid sm:grid-cols-2 gap-4 z-20 max-lg:px-4">
                                <div className="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-7 fill-[--second_color]" viewBox="0 0 512 512">
                                    ...
                                    <p className="text-lg text-gray-600 mt-2"> 123 Main Street, City, Country</p>
                                </div>
                                <div className="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-7 fill-[--second_color]" viewBox="0 0 473.806 473.806">
                                    ...
                                    <p className="text-lg text-gray-600 mt-2">+158 996 888</p>
                                </div>
                                <div className="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-7 fill-[--second_color]" viewBox="0 0 32 32">
                                    ...
                                    <p className="text-lg text-gray-600 mt-2">info@example.com</p>
                                </div>
                                <div className="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-7 fill-[--second_color]" viewBox="0 0 100 100">
                                    ...
                                    <p className="text-lg text-gray-600 mt-2">+1-548-2588</p>
                                </div>
                            </div>
                        ...
                        <div className="lg:col-span-2  rounded-lg  z-10 max-lg:-order-1 max-lg:mb-8">
                            <ContactFrom />
                        </div>
                    </div>
                </div>
